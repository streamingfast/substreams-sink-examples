...
import { MisbehaviorType } from "./MisbehaviorType";

export class Misbehavior {
  static encode(message: Misbehavior, writer: Writer): void {
    writer.uint32(8);
  ...
  static decode(reader: Reader, length: i32): Misbehavior {
