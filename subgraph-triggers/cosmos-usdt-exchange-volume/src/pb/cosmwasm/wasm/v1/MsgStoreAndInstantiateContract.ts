...
export class MsgStoreAndInstantiateContract {
  static encode(message: MsgStoreAndInstantiateContract, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): MsgStoreAndInstantiateContract {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new MsgStoreAndInstantiateContract();
