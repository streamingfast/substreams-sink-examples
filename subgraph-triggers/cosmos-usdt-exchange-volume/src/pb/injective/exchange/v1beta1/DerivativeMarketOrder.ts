...
export class DerivativeMarketOrder {
  static encode(message: DerivativeMarketOrder, writer: Writer): void {
    ...
    writer.uint32(34);
    writer.string(message.marginHold);
  ...
  static decode(reader: Reader, length: i32): DerivativeMarketOrder {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new DerivativeMarketOrder();
