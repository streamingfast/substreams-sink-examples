...
export class MsgCreateBinaryOptionsLimitOrder {
  static encode(
  ...
  static decode(reader: Reader, length: i32): MsgCreateBinaryOptionsLimitOrder {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new MsgCreateBinaryOptionsLimitOrder();
