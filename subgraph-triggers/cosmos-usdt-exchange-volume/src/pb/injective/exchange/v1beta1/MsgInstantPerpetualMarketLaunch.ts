...
export class MsgInstantPerpetualMarketLaunch {
  static encode(
  ...
  static decode(reader: Reader, length: i32): MsgInstantPerpetualMarketLaunch {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new MsgInstantPerpetualMarketLaunch();
