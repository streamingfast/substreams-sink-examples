...
export class MsgCancelDerivativeOrder {
  static encode(message: MsgCancelDerivativeOrder, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): MsgCancelDerivativeOrder {
