 ...
 */
export interface UnaryRequest<I extends Message<I> = AnyMessage, O extends Message<O> = AnyMessage> extends RequestCommon<I, O> {
    /**
 ...
 */
export interface UnaryResponse<I extends Message<I> = AnyMessage, O extends Message<O> = AnyMessage> extends ResponseCommon<I, O> {
    /**
 ...
 */
export interface StreamRequest<I extends Message<I> = AnyMessage, O extends Message<O> = AnyMessage> extends RequestCommon<I, O> {
    /**
     * The `stream` property discriminates between UnaryRequest and
     * StreamingRequest.
     */
 ...
 * zero or more input messages, and zero or more output messages.
 */
export interface StreamResponse<I extends Message<I> = AnyMessage, O extends Message<O> = AnyMessage> extends ResponseCommon<I, O> {
    /**
     * The `stream` property discriminates between UnaryResponse and
     * StreamingConn.
     */
