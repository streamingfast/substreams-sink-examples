import { Module, Module_Input, Module_Input_Store_Mode, Module_KindMap, Module_KindStore, Module_KindStore_UpdatePolicy, Module_Output, } from "@substreams/core/proto";
const MAX_UINT_64 = 18446744073709551615n;
export function createModuleFromManifest(module, index) {
    ...
    for (const [index, input] of module.inputs.entries()) {
        if ("source" in input) {
            out.inputs.push(new Module_Input({
                input: {
                    case: "source",
                    value: {
                        type: input.source,
