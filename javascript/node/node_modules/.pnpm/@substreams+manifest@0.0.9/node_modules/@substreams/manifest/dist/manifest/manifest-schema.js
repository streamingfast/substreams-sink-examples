...
export const InputSchema = Schema.union(Schema.struct({
    map: Schema.string,
}), Schema.struct({
...
export const InitialBlockSchema = Schema.union(Schema.bigint.pipe(Schema.nonNegativeBigint()), Schema.number.pipe(Schema.nonNegative()).pipe(Schema.transform(Schema.bigint, (value) => BigInt(value), (value) => Number(value))));
...
export const ManifestSchema = Schema.struct({
    ...
    binaries: Schema.optional(Schema.record(Schema.string, Schema.lazy(() => BinarySchema))),
    imports: Schema.optional(Schema.record(Schema.string.pipe(Schema.pattern(/^[A-Za-z_][A-Za-z0-9_-]*$/)), expandEnvTransform)),
