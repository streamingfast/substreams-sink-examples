...
export function createPackageFromManifest(manifest, cwd, { skipSourceCodeImportValidation = false } = {}) {
    ...
    for (const module of manifest.modules) {
        pkg.moduleMeta.push(new ModuleMetadata({
            packageIndex: 0n,
        ...
        if (index === undefined) {
            ...
            if (skipSourceCodeImportValidation) {
                ...
                modules.binaries.push(new Binary({
