...
type TransformCatchFinallyFn<C> = ((reason: unknown | undefined) => void) | ((reason: unknown | undefined) => C | undefined) | ((reason: unknown | undefined) => Promise<C | undefined>);
/**
 ...
 * @private Internal code, does not follow semantic versioning.
 */
export declare function transformNormalizeMessage<T extends Message<T>>(messageType: MessageType<T>): AsyncIterableTransform<T | PartialMessage<T>, T>;
/**
