import type { BinaryReadOptions, BinaryWriteOptions, JsonReadOptions, JsonWriteOptions, Message, MessageType, MethodInfo, PartialMessage } from "@bufbuild/protobuf";
/**
...
export declare function getJsonOptions(options: Partial<JsonReadOptions & JsonWriteOptions> | undefined): {
    ...
    typeRegistry?: import("@bufbuild/protobuf").IMessageTypeRegistry | undefined;
    emitDefaultValues?: boolean | undefined;
 ...
 * @private Internal code, does not follow semantic versioning.
 */
export declare function createMethodSerializationLookup<I extends Message<I>, O extends Message<O>>(method: MethodInfo<I, O>, binaryOptions: Partial<BinaryReadOptions & BinaryWriteOptions> | undefined, jsonOptions: Partial<JsonReadOptions & JsonWriteOptions> | undefined, limitOptions: {
 ...
 * @private Internal code, does not follow semantic versioning.
 */
export interface MethodSerializationLookup<I extends Message<I>, O extends Message<O>> {
    /**
 ...
 * @private Internal code, does not follow semantic versioning.
 */
export declare function createClientMethodSerializers<I extends Message<I>, O extends Message<O>>(method: MethodInfo<I, O>, useBinaryFormat: boolean, jsonOptions?: JsonSerializationOptions, binaryOptions?: BinarySerializationOptions): {
    normalize: (input: PartialMessage<I>) => I;
    parse: (data: Uint8Array) => O;
    serialize: (data: I) => Uint8Array;
};
/**
 ...
 */
export declare function createBinarySerialization<T extends Message<T>>(messageType: MessageType<T>, options: BinarySerializationOptions | undefined): Serialization<T>;
/**
 ...
 */
export declare function createJsonSerialization<T extends Message<T>>(messageType: MessageType<T>, options: JsonSerializationOptions | undefined): Serialization<T>;
export {};
