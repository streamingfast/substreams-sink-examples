 ...
 * @since 1.0.0
 */
export const createRefinement = (from, decode, isReversed, annotations = {}) => ({
  _tag: "Refinement",
  from,
  decode,
  isReversed,
 ...
 * @since 1.0.0
 */
export const createPropertySignatureTransformation = (from, to, decode, encode) => ({
  from,
  to,
  decode,
  encode
...
/** @internal */
export const _createTransform = (from, to, decode, encode, propertySignatureTransformations, annotations = {}) => ({
  _tag: "Transform",
  from,
  to,
  decode,
 ...
 * @since 1.0.0
 */
export const createTransform = (from, to, decode, encode, annotations = {}) => _createTransform(from, to, decode, encode, [], annotations);
/**
 * @category constructors
 * @since 1.0.0
 */
export const createTransformByPropertySignatureTransformations = (from, to, propertySignatureTransformations, annotations = {}) => _createTransform(from, to, input => {
...
const sortPropertySignatures = /*#__PURE__*/RA.sort( /*#__PURE__*/pipe(Number.Order, /*#__PURE__*/Order.mapInput(ps => getCardinality(ps.type))));
