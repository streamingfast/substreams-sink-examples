 ...
 * @since 1.0.0
 */
export const parseSync = schema => getSync(schema.ast);
/**
 * @category parsing
 * @since 1.0.0
 */
export const parseOption = schema => getOption(schema.ast);
/**
 * @category parsing
 * @since 1.0.0
 */
export const parseEither = schema => getEither(schema.ast);
/**
 * @category parsing
 * @since 1.0.0
 */
export const parseResult = schema => go(schema.ast);
/**
 * @category parsing
 * @since 1.0.0
 */
export const parsePromise = schema => getPromise(schema.ast);
/**
 * @category parsing
 * @since 1.0.0
 */
export const parse = schema => getEffect(schema.ast);
/**
 * @category decoding
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
export const validateSync = schema => getSync(AST.to(schema.ast));
/**
 * @category validation
 * @since 1.0.0
 */
export const validateOption = schema => getOption(AST.to(schema.ast));
/**
 * @category validation
 * @since 1.0.0
 */
export const validateEither = schema => getEither(AST.to(schema.ast));
/**
 * @category validation
 * @since 1.0.0
 */
export const validateResult = schema => go(AST.to(schema.ast));
/**
 * @category validation
 * @since 1.0.0
 */
export const validatePromise = schema => getPromise(AST.to(schema.ast));
/**
 * @category validation
 * @since 1.0.0
 */
export const validate = schema => getEffect(AST.to(schema.ast));
/**
 * @category validation
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
export const encodeSync = schema => getSync(reverse(schema.ast));
/**
 * @category encoding
 * @since 1.0.0
 */
export const encodeOption = schema => getOption(reverse(schema.ast));
/**
 * @category encoding
 * @since 1.0.0
 */
export const encodeEither = schema => getEither(reverse(schema.ast));
/**
 * @category encoding
 * @since 1.0.0
 */
export const encodeResult = schema => go(reverse(schema.ast));
/**
 * @category encoding
 * @since 1.0.0
 */
export const encodePromise = schema => getPromise(reverse(schema.ast));
/**
 * @category encoding
 * @since 1.0.0
 */
export const encode = schema => getEffect(reverse(schema.ast));
    ...
    case "Refinement":
      {
        if (ast.isReversed) {
          ...
          return (i, options) => handleForbidden(PR.flatMap(from(i, options), a => ast.decode(a, options)), options);
        }
      }
    case "Transform":
      {
        ...
        if (isBoundary) {
          ...
          return (i1, options) => handleForbidden(PR.flatMap(from(i1, options), a => PR.flatMap(ast.decode(a, options), i2 => to(i2, options))), options);
        } else {
          return (a, options) => handleForbidden(PR.flatMap(ast.decode(a, options), i2 => to(i2, options)), options);
        }
      }
    case "Declaration":
      {
