 ...
 * @category execution
 */
export declare const runFork: <R>(runtime: Runtime<R>) => <E, A>(self: Effect.Effect<R, E, A>, options?: RunForkOptions | undefined) => Fiber.RuntimeFiber<E, A>;
/**
 ...
 * @category symbols
 */
export declare const NodePrint: unique symbol;
/**
 * @since 1.0.0
 * @category symbols
 */
