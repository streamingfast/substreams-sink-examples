...
var TestClock = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/testing/testClock"));
var TestServices = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/testing/testServices"));
...
/** @internal */
exports.live = live;
const liveContext = () => layer.syncContext(() => defaultServices.liveServices);
/** @internal */
exports.liveContext = liveContext;
const testContext = () => layer.provideMerge(liveContext(), live);
