...
var FiberRefsPatch = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/FiberRefs/Patch"));
...
var _completedRequestMap = /*#__PURE__*/require("@effect/io/internal/completedRequestMap");
var concurrency = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/concurrency"));
var _configProvider = /*#__PURE__*/require("@effect/io/internal/configProvider");
...
var internalEffect = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/effect"));
...
var internalLogger = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/logger"));
var metric = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/metric"));
var metricBoundaries = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/metric/boundaries"));
...
var SupervisorPatch = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/supervisor/patch"));
var tracer = /*#__PURE__*/_interopRequireWildcard( /*#__PURE__*/require("@effect/io/internal/tracer"));
...
const raceWith = /*#__PURE__*/(0, _Function.dual)(2, (self, options) => raceFibersWith(self, {
  other: options.other,
...
const race = /*#__PURE__*/(0, _Function.dual)(2, (self, that) => core.checkInterruptible(isInterruptible => raceAwait(raceDisconnect(that, isInterruptible))(raceDisconnect(self, isInterruptible))));
/** @internal */
exports.race = race;
...
/** @internal */
const raceAwait = /*#__PURE__*/(0, _Function.dual)(2, (self, that) => core.fiberIdWith(parentFiberId => raceWith(self, {
  other: that,
...
const raceFibersWith = /*#__PURE__*/(0, _Function.dual)(2, (self, options) => core.withFiberRuntime((parentFiber, parentStatus) => {
  const parentRuntimeFlags = parentStatus.runtimeFlags;
  const raceIndicator = MRef.make(true);
  const leftFiber = unsafeMakeChildFiber(self, parentFiber, parentRuntimeFlags);
  const rightFiber = unsafeMakeChildFiber(options.other, parentFiber, parentRuntimeFlags);
