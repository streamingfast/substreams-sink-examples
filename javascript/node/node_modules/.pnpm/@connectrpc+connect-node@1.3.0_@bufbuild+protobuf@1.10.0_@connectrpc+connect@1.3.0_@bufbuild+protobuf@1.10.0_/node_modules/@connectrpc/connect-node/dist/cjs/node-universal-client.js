...
exports.createNodeHttpClient = void 0;
...
function createNodeHttpClient(options) {
    ...
    const sessionProvider = (_a = options.sessionProvider) !== null && _a !== void 0 ? _a : ((authority) => new http2_session_manager_js_1.Http2SessionManager(authority));
...
function createNodeHttp1Client(httpOptions) {
    return async function request(req) {
        ...
        return new Promise((resolve, reject) => {
            ...
            h1Request(sentinel, req.url, Object.assign(Object.assign({}, httpOptions), { headers: (0, node_universal_header_js_1.webHeaderToNodeHeaders)(req.header), method: req.method }), (request) => {
