...
/** @internal */
export const isRedBlackTree = u => isObject(u) && "_id" in u && u["_id"] === RedBlackTreeTypeId;
/** @internal */
...
/** @internal */
export const findAll = /*#__PURE__*/Dual.dual(2, (self, key) => {
  const stack = [];
  let node = self._root;
...
/** @internal */
export const forEachBetween = /*#__PURE__*/Dual.dual(2, (self, {
  body,
  max,
  min
}) => {
