 ...
 * @since 1.0.0
 */
export const getEquivalence = isEquivalent => Equivalence.make((self, that) => toReadonlyArray(self).every((value, i) => isEquivalent(value, unsafeGet(that, i))));
 ...
 * @since 1.0.0
 */
export const isChunk = u => isObject(u) && "_id" in u && u["_id"] === TypeId;
 ...
 * @category mapping
 */
export const map = /*#__PURE__*/dual(2, (self, f) => self.backing._tag === "ISingleton" ? of(f(self.backing.a, 0)) : unsafeFromArray(RA.map((a, i) => f(a, i))(toReadonlyArray(self))));
/**
 ...
 * @since 1.0.0
 */
export const partition = /*#__PURE__*/dual(2, (self, predicate) => (([l, r]) => [unsafeFromArray(l), unsafeFromArray(r)])(RA.partition(toReadonlyArray(self), predicate)));
/**
 ...
 * @since 1.0.0
 */
export const partitionMap = /*#__PURE__*/dual(2, (self, f) => (([l, r]) => [unsafeFromArray(l), unsafeFromArray(r)])(RA.partitionMap(toReadonlyArray(self), f)));
/**
