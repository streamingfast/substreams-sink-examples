 ...
 * @since 1.0.0
 */
export const isTagged = /*#__PURE__*/dual(2, (self, tag) => isObject(self) && "_tag" in self && self["_tag"] === tag);
/**
 ...
 * @since 1.0.0
 */
export const isIterable = input => isObject(input) && Symbol.iterator in input;
/**
