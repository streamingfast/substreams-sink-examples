 ...
 * @since 1.0.0
 */
export const isEither = input => isObject(input) && "_id" in input && input["_id"] === TypeId;
/**
 ...
 * @since 1.0.0
 */
export const mapRight = /*#__PURE__*/dual(2, (self, f) => isRight(self) ? right(f(self.right)) : left(self.left));
/**
