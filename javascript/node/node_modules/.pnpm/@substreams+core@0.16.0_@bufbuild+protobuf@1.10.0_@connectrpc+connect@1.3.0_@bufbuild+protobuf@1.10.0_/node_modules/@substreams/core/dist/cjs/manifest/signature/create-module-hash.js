...
exports.createModuleHash = createModuleHash;
exports.createModuleHashHex = createModuleHashHex;
...
var _createModuleGraph = /*#__PURE__*/require("../graph/create-module-graph.js");
async function createModuleHashHex(modules, moduleOrName, graph = (0, _createModuleGraph.createModuleGraph)(modules.modules ?? [])) {
  return (0, _toHex.toHex)(await createModuleHash(modules, moduleOrName, graph));
}
async function createModuleHash(modules, moduleOrName, graph = (0, _createModuleGraph.createModuleGraph)(modules.modules ?? [])) {
  const module = typeof moduleOrName === "string" ? (0, _getModule.getModuleOrThrow)(modules.modules, moduleOrName) : moduleOrName;
  ...
  return (0, _createHash.createHash)(array);
}
